...
<body >
    <div class="max-w-4xl p-6 mx-auto bg-gray-200 rounded-md shadow-md dark:bg-gray-800 mt-20">
        ...
        @endif  
        <h1 class="text-xl font-bold text-gray-800 capitalize dark:text-white py-1 ">Ajouter une cotisation</h1>
        <br>  
        <form  method="post" action="{{ route('Validate.create') }}" novalidate>
            @csrf
            ...
            <div class="form-group mb-2">
                ...
                <input type="text" class="form-control @error('frais') is-invalid @enderror" name="frais" id="frais">
                @error('frais')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
