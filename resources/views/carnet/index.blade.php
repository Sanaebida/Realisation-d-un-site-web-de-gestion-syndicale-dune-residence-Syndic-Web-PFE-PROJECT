...
<link rel="stylesheet" href="{{ asset('css/lilstyles.css') }}">
    ...
    <div class="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800 ">
        ...
        <div class="main-container">
            ...
            <div class="cards">
              ...
              <div class="card card-2">
                ...
                <p class="card__apply">
                  <a class="card__link" href="#">Voir Plus</a>
                </p>
              </div>
        ...
        <div class="relative overflow-x-auto sm:rounded-lg mt-5">
             ...
             <a class="Relative parent absolute top-0 right-0 bg-indigo-500 text-white active:bg-indigo-600 font-bold uppercase text-xs px-4 py-3 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150" type="button" href="{{ route('carnet.create') }}">
